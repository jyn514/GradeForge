...
SECTIONS := $(addsuffix .csv,$(addprefix $(SECTION_DIR)/,Fall-2013 Fall-2014 Fall-2015 Fall-2016 Fall-2017 Fall-2018 Summer-2014 Summer-2015 Summer-2016 Summer-2017 Summer-2018 Spring-2014 Spring-2015 Spring-2016 Spring-2017 Spring-2018))
...
test: sql | images
	...
	pytest gradeforge
	if grep Moay $(EXAM_OUTPUT); then exit 1; fi
	if pylint --extension-pkg-whitelist=lxml gradeforge | grep '^E:'; then exit 1; fi
